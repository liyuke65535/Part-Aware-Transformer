...
# local views
_C.MODEL.LOCAL = False
_C.MODEL.MULTI_NECK = False
_C.MODEL.FEAT_FUSION = False
_C.MODEL.PC_SCALE = 0.01
_C.MODEL.PC_LOSS = False

# soft label
_C.MODEL.SOFT_LABEL = False
_C.MODEL.CLUSTER_K = 10 # num of clusters
_C.MODEL.SOFT_WEIGHT = 0.1
_C.MODEL.SOFT_LAMBDA = 0.2

# self distill settings
_C.MODEL.DISTILL = CN()
_C.MODEL.DISTILL.HINT = False # if using hint
_C.MODEL.DISTILL.LOCAL_HINT = False # if using local hint
_C.MODEL.DISTILL.ALPHA = 0.1 # for balancing ce and kl loss
_C.MODEL.DISTILL.BETA = 0.1 # for deep supervision weight
_C.MODEL.DISTILL.LAMBDA = 0.1 # {0.1 0.2 0.5} weight for hint weight
_C.MODEL.DISTILL.IF_HEAD = False
_C.MODEL.DISTILL.IF_DEEP_SUPERVISE = True
_C.MODEL.DISTILL.NUM_SELECT_BLOCK = 1 # ratio for num of selected blocks
_C.MODEL.DISTILL.START_EPOCH = 1 # the first time to distill, start from 1
_C.MODEL.DISTILL.LOSS_TYPE = 'KL' # loss type
_C.MODEL.DISTILL.DOUBLE_KL = False
_C.MODEL.DISTILL.HARD_DISTILL = False
_C.MODEL.DISTILL.KL_TAO = 3.0 # {3.0 5.0} scale
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
_C.TEST.EVAL = False
# only visualize using t-sne
_C.TEST.TSNE_ONLY = False
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
