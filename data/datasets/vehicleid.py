...
class SmallVehicleID(VehicleID):
    ...
    def __init__(self, root='datasets', **kwargs):
        # self.dataset_dir = osp.join(root, self.dataset_dir)
        self.test_list = osp.join(root, self.dataset_dir, 'train_test_split/test_list_800.txt')
...
class MediumVehicleID(VehicleID):
    ...
    def __init__(self, root='datasets', **kwargs):
        # self.dataset_dir = osp.join(root, self.dataset_dir)
        self.test_list = osp.join(root, self.dataset_dir, 'train_test_split/test_list_1600.txt')
...
class LargeVehicleID(VehicleID):
    ...
    def __init__(self, root='datasets', **kwargs):
        # self.dataset_dir = osp.join(root, self.dataset_dir)
        self.test_list = osp.join(root, self.dataset_dir, 'train_test_split/test_list_2400.txt')
