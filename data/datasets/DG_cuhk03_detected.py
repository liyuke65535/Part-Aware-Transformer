...
class DG_CUHK03_detected(ImageDataset):
    """CUHK03.
    ...
    def __init__(self, root='datasets', split_id=0, cuhk03_labeled=False, cuhk03_classic_split=True, **kwargs):
        self.root = root
        ...
        super(DG_CUHK03_detected, self).__init__(train, [], [], **kwargs)
